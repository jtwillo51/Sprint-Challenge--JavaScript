...
const tyrannosaurus = {diet:'carnivorous' , weight:'7000kg' , length:'12m' , period:'Late Cretaceous' };
...
const universities = graduates.map(function(person){return person.first_name});
...
*/
const pops = zooAnimals.map(animal => animal.population)
const populationTotal = pops.reduce((acc, cv)=> acc + cv)
